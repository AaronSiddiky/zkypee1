...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-r from-[#0078D4]/50 to-[#00AFF0]/50 backdrop-blur-sm border-t border-white/10 py-10 mt-auto">
      <div className="max-w-7xl mx-auto px-8">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            <div className="text-2xl font-bold text-white mb-1">Zkypee</div>
            <p className="text-white/70 text-sm">Made by betrayed Skype users at Columbia University</p>
          </div>
        ...
        <div className="mt-8 pt-6 border-t border-white/10 flex flex-col md:flex-row justify-between items-center">
          <div className="text-white/60 text-sm">
            © {new Date().getFullYear()} Zkypee. All rights reserved.
          </div>
