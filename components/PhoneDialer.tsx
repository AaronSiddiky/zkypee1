  ...
  return (
    <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-6">
      ...
      <div className="grid grid-cols-3 gap-6">
        {[1, 2, 3, 4, 5, 6, 7, 8, 9, '*', 0, '#'].map((num, index) => (
          <button
            ...
            className="h-16 w-16 rounded-full flex flex-col items-center justify-center mx-auto"
          >
      ...
      <div className="flex justify-between items-center mt-6">
        ...
        <button 
          onClick={handleCall}
          className="h-16 w-16 rounded-full bg-blue-400 flex items-center justify-center"
        >
