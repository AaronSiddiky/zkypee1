...
const supabaseAnonKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inhqc2xpcGR6Y2JkanRlcW5hd3B0Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDA5MzcxMDMsImV4cCI6MjA1NjUxMzEwM30.yfgMsfGMzf1KE7XGWIunR5oKZBr3SKYBQv4anLcqCA8';
      ...
      <main className="max-w-md mx-auto px-8 py-12">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600">
            Be the first to know when Zkypee launches and get early access to our platform.
          </p>
        </div>
        ...
        {isSuccess ? (
          <div className="bg-green-50 border border-green-200 rounded-lg p-6 text-center">
            ...
            <p className="text-gray-600 mb-6">
              Thanks for joining our waitlist. We'll notify you when Zkypee is ready.
            </p>
          ...
          <form onSubmit={handleSubmit} className="bg-gray-50 rounded-lg p-6 shadow-sm">
            {error && (
