    ...
    <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
            ...
            <p className="text-gray-600">
              Experience HD audio quality with our advanced codecs that adapt to
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
            ...
            <p className="text-gray-600">
              Connect face-to-face with crisp, high-definition video that works
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
            ...
            <p className="text-gray-600">
              Host meetings with up to 50 participants with our business plans,
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
            ...
            <p className="text-gray-600">
              Call landlines and mobiles worldwide at rates up to 50% lower than
              Skype.
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
            ...
            <p className="text-gray-600">
              Your Zkypee credits never expire, unlike Skype's 180-day policy.
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
            ...
            <p className="text-gray-600">
              End-to-end encryption for all calls and messages keeps your
      ...
      >
        <h2 className="text-2xl font-bold mb-4">
          Ready to experience better communication?
        </h2>
        <p className="text-gray-600 mb-6">
          Sign up today to try Zkypee risk-free.
        </p>
